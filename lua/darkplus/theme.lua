...
theme.set_highlights = function()
   ...
   -- Pmenu
   hl(0, 'Pmenu', { link = '', fg = c.gray11, bg = c.menu_bg }) -- fg = c.alt_fg, bg = c.menu_bg
   hl(0, 'PmenuSel', { fg = 'NONE', bg = c.ui5_blue })
   hl(0, 'PmenuSbar', { fg = 'NONE', bg = c.ui5_blue })
   hl(0, 'PmenuThumb', { fg = 'NONE', bg = c.ui5_blue })
   hl(0, 'PmenuKind', { fg = c.gray11, bg = c.menu_bg })
   hl(0, 'PmenuExtra', { fg = c.gray11, bg = c.menu_bg })
   ...
   hl(0, 'NormalFloat', { fg = c.gray11, bg = c.menu_bg }) -- fg = 'NONE, bg = c.bg
   ...
   hl(0, 'NonText', { fg = c.gray8, bg = 'NONE' })
   ...
   hl(0, 'BlinkCmpDoc', { fg = c.gray10 }) -- blink-cmp のコード補完の fg が暗いので修正

   -- hl(0, 'BlinkCmpKindEnum', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindFile', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindText', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindUnit', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindClass', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindColor', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindEvent', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindField', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindValue', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindFolder', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindMethod', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindModule', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindStruct', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindKeyword', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindSnippet', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindConstant', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindFunction', { fg = c.gray10 })
   hl(0, 'BlinkCmpKindOperator', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindProperty', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindVariable', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindInterface', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindReference', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindEnumMember', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindConstructor', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpKindTypeParameter', { fg = c.gray10 })
   hl(0, 'BlinkCmpKind', { fg = c.gray10 })

   -- PmenuExtra にlink してるのが多いのでそっちの fg を変更
   -- hl(0, 'BlinkCmpCursorLineMenuHack', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpCursorLineDocumentationHack', { fg = c.gray10 })
   -- -- hl(0, 'BlinkCmpGhostText', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpDocCursorLine', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpSource', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpMenuSelection', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpLabelDetail', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpScrollBarGutter', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpScrollBarThumb', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpLabelDeprecated', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpLabelDescription', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpMenu', { fg = c.gray10 })
   -- -- hl(0, 'BlinkCmpDocBorder', { fg = c.gray10 })
   -- -- hl(0, 'BlinkCmpMenuBorder', { fg = c.gray10 })
   -- -- hl(0, 'BlinkCmpDocSeparator', { fg = c.gray10 })
   -- -- hl(0, 'BlinkCmpSignatureHelpBorder', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpSignatureHelp', { fg = c.gray10 })
   -- hl(0, 'BlinkCmpSignatureHelpActiveParameter', { fg = c.gray10 })
   ...
   -- mini.icons
   hl(0, 'MiniIconsGrey', { fg = c.gray })
   hl(0, 'MiniIconsPurple', { fg = c.purple })
   hl(0, 'MiniIconsBlue', { fg = c.blue })
   hl(0, 'MiniIconsAzure', { fg = c.folder_blue })
   hl(0, 'MiniIconsCyan', { fg = c.cyan })
   hl(0, 'MiniIconsGreen', { fg = c.green })
   hl(0, 'MiniIconsYellow', { fg = c.yellow })
   hl(0, 'MiniIconsOrange', { fg = c.orange })
