...
theme.set_highlights = function()
   ...
   hl(0, "@markup.list.checked", { fg = c.red, bold = true })   -- [x] task list checked
   hl(0, "@markup.list.checked.text", { fg = c.gray })
   hl(0, "@markup.list.unchecked", { fg = c.red, bold = true }) -- [ ] task list unchecked
   hl(0, "@markup.list.unchecked.text", { fg = c.fg })
   -- hl(0, "@tasklist.pending", { fg = c.red })           -- [-] task list pending (cannot markup orz)
